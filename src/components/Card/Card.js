							...
							<div className={styles.cardContainer} id={index}>
								...
								<div className={styles.dataVideoContainer}>
									...
									<div className={styles.dataVideoContainer_item}>
										...
										<p>{`${dataObj(el[0].snippet.publishedAt).getDate()} ${dataObj(el[0].snippet.publishedAt).getMonth()} ${dataObj(el[0].snippet.publishedAt).getFullYear()}`}</p>
									</div>
									<div className={styles.dataVideoContainer_item}>
										<div className={styles.svgContainer} >
